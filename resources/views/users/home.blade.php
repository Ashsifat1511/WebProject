...
<body class="bg-white text-black">
      ...
      <div class="flex-none gap-2">
         <div class="form-control">
            <form action="{{ route('home.search') }}">
               <input type="text" placeholder="Search" class="input input-bordered w-24 md:w-auto bg-white" name="search">
               <button type="submit" class="btn btn-square btn-ghost">
                  <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                     <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M21 21l-5-5m2-5a9 9 0 11-18 0 9 9 0 0118 0z" />
                  </svg>
               </button>
            </form>
         </div>
   ...
   <div class="px-2 md:px-12 w-full mx-auto">
      <h1 class="text-2xl md:text-4xl font-medium text-center text-gray-800 my-4">Gaming</h1>
   ...
   <div class="px-2 md:px-12 w-full mx-auto my-16">
      <h1 class="text-2xl md:text-4xl font-medium text-center text-gray-800 my-4">Others</h1>
      <div class="grid grid-cols-1 md:grid-cols-3 gap-6 mt-12 items-center justify-center mx-auto w-full">
