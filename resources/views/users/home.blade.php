...
<body>
               ...
               <div class="main">
                  ...
                  <div class="input-group">
                     <form action="{{ route('home.search') }}">
                        ...
                        <button class="btn btn-secondary" type="submit" style="background-color: #f26522; border-color:#f26522;"><img src="{{ asset('images/search-icon.png') }}"></button>
                     </form>
                  </div>
               </div>
   ...
   <div class="fashion_section">
      <div id="main_slider" class="carousel slide" data-ride="carousel">
         <div class="carousel-inner">
            @foreach ($gamingitems as $index => $item)
   ...
   <div class="fashion_section">
      <div id="main_slider" class="carousel slide" data-ride="carousel">
         <div class="carousel-inner">
            @foreach ($othersitems as $index => $item)
            <div class="carousel-item {{ $index == 0 ? 'active' : '' }}">
               <div class="container">
                  <h1 class="fashion_taital">Others</h1>
                  <div class="fashion_section_2">
                     <div class="row">
                        <div class="col-lg-4 col-sm-4">
                           <div class="box_main">
